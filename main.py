...
async def start_cmd(message: types.Message):
    ...
    welcome_text = (
        ...
        f"Menga matn yuborishingiz, 📸 <b>rasm</b> tashlab tahlil qildirishingiz yoki 🎙 <b>ovozli xabar</b> yuborishingiz mumkin.\n\n"
...
# Ovozli xabarlarni (Voice) tushunish
@dp.message(F.voice)
    ...
    try:
        ...
        response = ai_client.models.generate_content(
            ...
            contents=[
                ...
                "Ushbu ovozli xabarni diqqat bilan eshit va foydalanuvchi aytgan gaplarga to'liq va aniq javob ber."
            ],
            config=genai_types.GenerateContentConfig(system_instruction=SYSTEM_INSTRUCTION)
        )
        await message.answer(response.text)
